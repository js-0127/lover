var index = 0
    document.querySelector('.content-l button').click(function () {
        index++
        if (index % 2 == 1) {
            document.querySelector('.content-l h2').attr("style",
                "transform: translate(-180px, 10px); width: 50%;")
            document.querySelector('.content-l span').attr("style",
                "transform: translate(-180px, 10px); width: 50%; font: 400 25px 'Gochi Hand'; line-height: 1.5; ")
            document.querySelector('.content-l button').attr("style",
                "width: 300px; height: 55px; top: 20%; background-position-x: 70px; transform: rotate(180deg);")
            document.querySelector('.circle').attr("style",
                "width: 400px;height: 400px;left: 57%;top: 50%;border: 23px #ffffff dashed; ")
            document.querySelector('.content-l img').attr("style",
                "bottom: 0px;")
            document.querySelector('.content-l').attr("style",
                "width: 63%;")
            document.querySelector('.content-r').attr("style",
                "width: 37%;")
            document.querySelector('.img').attr("style",
                "padding: 10px; transform: scale(1);")
            document.querySelector('.img img').attr("style",
